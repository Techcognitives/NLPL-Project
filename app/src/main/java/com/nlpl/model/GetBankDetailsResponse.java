...
public class GetBankDetailsResponse {
    ...
    private List<bankDetailByBankId> data;


    public List<bankDetailByBankId> getData() {
        return data;
    }

    public void setData(List<bankDetailByBankId> data) {
        this.data = data;
    }

    public class bankDetailByBankId {
        private String user_id, accountholder_name, account_number, re_enter_acc_num, IFSI_CODE, bank_id, bank_name, cancelled_cheque,
                created_at, updated_at, updated_by, deleted_at, deleted_by, bank_ref_no, beneficiary_name, transaction_remark, verification_status;
