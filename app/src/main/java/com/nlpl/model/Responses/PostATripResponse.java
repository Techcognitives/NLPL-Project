...
public class PostATripResponse {
    ...
    public class Data {
        ...
        private String trip_posted_at;
        private String trip_ends_at;
        ...
        public String getTrip_posted_at() {
            return trip_posted_at;
        }

        public String getTrip_ends_at() {
            return trip_ends_at;
        }
        ...
        public void setTrip_posted_at(String trip_posted_at) {
            this.trip_posted_at = trip_posted_at;
        }

        public void setTrip_ends_at(String trip_ends_at) {
            this.trip_ends_at = trip_ends_at;
        }
    }
}
