...
public class GetLoadDetailsResponse {
    private String success;
    private List<LoadList> data;

    public List<LoadList> getData() {
        return data;
    }

    public void setData(List<LoadList> data) {
        this.data = data;
    }

    public class LoadList {
        public String idpost_load,user_id,pick_up_date,pick_up_time,budget,revised_budget_one,bid_status,revised_budget_two,
                vehicle_model,feet,capacity,body_type,pick_add,pick_pin_code,pick_city,pick_state,pick_country,drop_add,
                drop_pin_code,drop_city,drop_country,drop_state,km_approx,notes_meterial_des,bid_posted_at,bid_ends_at,
